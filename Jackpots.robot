...
Open Jackpot Create Form
    ...
    Wait Until Page Has    xpath://div[contains(@class,'ant-modal-container')]//div[@role='tab' and contains(@class,'ant-tabs-tab-btn') and normalize-space(.)='General']
    Wait Until Page Has    xpath://div[contains(@class,'ant-modal-container')]//input[@id='code_desc' and not(@disabled)]
